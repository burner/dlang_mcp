...
class IngestionPipeline
{
    ...
    void ingestPackage(string packageName)
    {
        ...
        try
        {
            ...
            writeln("  Indexed: ", modulesCount, " modules, ", functionsCount, " functions, ", typesCount, " types, ", examplesCount, " examples");
    ...
    private void updateProgress(string lastPackage, string status, string errorMessage = null, long processed = -1)
    {
        auto stmt = conn.prepare("
